report 54102 "ALC Sales Quote RPE"
{
    RDLCLayout = 'ALCSalesQuoteRPE.rdlc';
    WordLayout = 'ALCSalesQuoteRPE.docx';
    //Caption = 'Sales - Quote';
    CaptionML = ESP = 'Ventas - Oferta';
    DefaultLayout = Word;
    ...
    begin
        /*rglh error documentado NOTAS EXTENSIONES 
