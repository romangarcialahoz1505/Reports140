report 54104 "ALC Sales CreditMemo RPE"

{
    RDLCLayout = 'ALCSalesCreditMemoRPE.rdlc';
    WordLayout = 'ALCSalesCreditMemoRPE.docx';
    //Caption = 'Sales - Credit Memo';
    CaptionML = ESP = 'Ventas - Abono';
    DefaultLayout = Word;
            ...
            dataitem(Line; "Sales Cr.Memo Line")
            {
                ...
                dataitem(AssemblyLine; "Posted Assembly Line")
                {
                    ...
                    begin
                        ...
                        /*rglh error anotado en NOTAS EXTENSIONES
