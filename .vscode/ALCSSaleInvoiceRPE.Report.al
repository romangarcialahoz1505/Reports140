report 54103 "ALC Sale Invoice RPE"

{
    RDLCLayout = 'ALCSalesInvoiceRPE.rdlc';
    WordLayout = 'ALCSalesInvoiceRPE.docx';
    //Caption = 'Sales - Invoice';
    CaptionML = ESP = 'Ventas - Factura';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            //rglh cambio el formato fecha
            column(DocumentDate; Format("Document Date", 0, 0))
            {
            }
            ...
            //rglh cambio el formato fecha
            column(DueDate; Format("Due Date", 0, 0))
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                dataitem(AssemblyLine; "Posted Assembly Line")
                {
                    ...
                    begin
                        ...
                        if not DisplayAssemblyInformation then
                            CurrReport.Break;
                        /*rglh GetAssemblyLinesForDocument(
                ...
                begin
                    ...
                    TotalAmount += Amount;
                    // rglh no añadido en la funcion del formato.
                    TotalAmountLineDisc += "Line Discount Amount";
            ...
            dataitem(Totals; "Integer")
            {
                ...
                // rglh añado suma total descuentos de las lineas sugun factura Aguadeaqui
                column(TotalAmountLineDisc; TotalAmountLineDisc)
                {
                }
            ...
            begin
                /* rglh if EnvInfoProxy.IsInvoicing then begin
                ...
                // rglh PaymentInstructionsTxt := O365SalesInvoiceMgmt.GetPaymentInstructionsFromPostedInvoice(Header);
    ...
    var
        ...
        TotalAmount: Decimal;
        //rglh añalo la variable
        TotalAmountLineDisc: Decimal;
